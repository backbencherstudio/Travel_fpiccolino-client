    ...
    return (
        ...
        >
            ...
            <div className="mb-4">
                ...
                <select
                    id="pageName"
                    className={`mt-1 p-1 block w-full rounded border ${errors.pageName ? "border-red-500" : "border-gray-300"
                        } focus:ring-blue-500 focus:border-blue-500`}
            ...
            <div className="mb-4">
                ...
                <select
                    id="name"
                    className={`mt-1 p-1 block w-full rounded border ${errors.name ? "border-red-500" : "border-gray-300"
                        } focus:ring-blue-500 focus:border-blue-500`}
