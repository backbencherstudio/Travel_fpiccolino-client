      ...
      <div className="mt-3  max-w-[680px]">
        <div className="grid grid-cols-2">
          <div>
            ...
            <p className="text-[#72777F] text-[14px]">{userData[id-1].name}</p>
          </div>{" "}
          <div>
            <h1 className="text-[16px]">Email</h1>
            <p className="text-[#72777F] text-[14px]">{userData[id-1].email}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 mt-3">
          <div>
            ...
            <p className="text-[#72777F] text-[14px]">{userData[id-1].city}</p>
          </div>{" "}
          <div>
            <h1 className="text-[16px]">Country</h1>
            <p className="text-[#72777F] text-[14px]">{userData[id-1].country}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 mt-3">
          <div>
            ...
            <p className="text-[#72777F] text-[14px]">{userData[id-1].bankCard}</p>
          </div>{" "}
          <div>
            <h1 className="text-[16px]">Payment System</h1>
            <p className="text-[#72777F] text-[14px]">{userData[id-1].paymentSystem}</p>
          </div>
        </div>
      </div>
