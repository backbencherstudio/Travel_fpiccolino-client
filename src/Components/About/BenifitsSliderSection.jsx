...
import banner from "../../assets/benifit.jpg";
import ProgressBars from "../../Shared/ProgressBars";

const BenifitsSliderSection = () => {
  ...
  return (
    <div
      ...
      className="bg-[#EFFBFB] py-[120px] relative mt-20"
    >
          ...
          >
            {cardDetails.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="p-5 rounded-lg bg-transparent shadow-md card_style items-center text-start content-center h-[420px] mx-5 lg:mx-0">
                  <h3 className=" text-[24px] font-duera-expanded font-bold text-white">
                    {item.title}
                  </h3>
...
export default BenifitsSliderSection;
