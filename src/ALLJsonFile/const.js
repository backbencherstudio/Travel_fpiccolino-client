...
export const reviews = [
  {
    ...
    description:
      "artnering with this Healthcare IT provider has transformed our practice’s operations. Their user-centric solutions streamlined our processes, allowing our staff to focus more on patient care rather than administrative tasks.",
  },
  {
    name: "Jerome Bell",
    image:
...
export const InsuranceData = [
  {
    ...
    discription:
      "This included insurance will provide you with assistance, medical coverage up to €5,000, and up to €1,000 for luggage, as well as a maximum of €310 for essential purchases.",
    details:
...
export const accordionData = [
  ...
  },
  {
    question: "Do I need to create an account to book a trip?",
    answer:
      " Yes, creating an account allows us to securely save your bookings and preferences, making your experience seamless and personalized  your bookings and preferences, making your experience seamless and personalized  ",
  },
];
...
export const packageCategory = ["All inclusive", "Italy", "USA", "Nepal"];
