        ...
        <ParentComponent>
          <div className="mt-20 flex">
            <Link to={`/flight/${id}`} className="flex items-center">
              <GoChevronLeft className="text-xl" /> Ritorno al volo
            </Link>
          </div>
          <div className="mt-10">
            <HeadLine
              title="Viaggia con fiducia: l'assicurazione su misura per te"
              description="Copertura completa per un viaggio senza preoccupazioni, ovunque tu vada"
            />
          </div>
        </ParentComponent>
            ...
            <div className="col-span-12 lg:col-span-8">
              <div>
                ...
                <p className="text-[#72777F] font-[18px]">
                  Assicurazione completa per un viaggio senza preoccupazioni
                </p>
              ...
              <div className="shadow-lg rounded-lg p-2 md:p-10">
                ...
                <div className="mt-4">
                  ...
                  {checkout?.flightPrice && (
                    <span className="flex items-start justify-between mb-3">
                      <h2 className="flex items-center">Importo del volo</h2>
                      <h2 className="text-[#000000] text-[18px] font-semibold text-center">
                        € = {checkout?.flightPrice}
                      </h2>
                    </span>
