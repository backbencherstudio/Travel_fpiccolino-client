...
const Flight = () => {
    ...
    // totalFlightAmount + updateToureAmount
                                ...
                                <div className="col-span-12 md:col-span-8 md:border-r border-dashed relative">
                                    ...
                                    {packageDetails?.bookedFlights.length === 0 ?
                                        <div className="flex items-center justify-center">
                                            <h2 className="text-center text-xl font-semibold text-red-400 my-5 md:mt-20" > Flight Not Available </h2>
                                        </div>
                        ...
                        <div className=" col-span-12 lg:col-span-4 mt-5 lg:mt-0">
                            ...
                            <div className=" shadow-lg rounded-lg p-2 md:p-10">
                                ...
                                <div className="mt-4">
                                    ...
                                    <span className="flex items-start justify-between mb-3 " >
                                        <h2>Passengers</h2>
                                        <h2 className="text-[#000000] text-[18px] font-semibold text-center " >{person} </h2>
                                    </span>
                                    {
                                        addFlight &&
                                        <span className="flex items-start justify-between mb-3 " >
                                    ...
                                    <span className="flex items-start justify-between mb-3 " >
                                        <h2>Total</h2>
                                        {/* <h2 className="text-[20px] font-semibold " >€ {!totalToureCost ? updateToureAmount : totalToureCost} </h2> */}
                                        {/* <h2 className="text-[20px] font-semibold " >€ {totalFlightAmount + updateToureAmount} </h2> */}
                                        <h2 className="text-[20px] font-semibold " >€ {totalToureCost} </h2>
                                    </span>
