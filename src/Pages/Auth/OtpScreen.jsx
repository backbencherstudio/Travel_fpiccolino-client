    ...
    <ParentAuthComponent>
            ...
            <div className="flex justify-between mt-8">
              {otp.map((digit, index) => (
                <input
                  ...
                  className={`w-[60px] h-[60px] text-sm text-center border ${
                    digit && "border-[#35aff4]"
      ...
      <dialog id="password_modal" className="modal">
        ...
        <h1 className="font-extrabold text-[32px] mt-8">Change Password</h1>
          ...
          <button
               onClick={() => document.getElementById("success_modal").showModal()}
              className="primary_bg p-3 w-full rounded-lg text-white text-[16px] font-semibold mt-6 "
            >
              Change Password
            </button>
      ...
      <dialog id="success_modal" className="modal">
        ...
        <h1 className="font-extrabold text-[32px] mt-8"> Successfully Password Changed</h1>
