...
const Tours = () => {
  ...
  const heroContent = {
    ...
    descriptionOne:
      "Experience the Richness sdfgsdfgds of Italian Culture, One Bite at a Time",
    titleTwo: "Italy",
    descriptionTwo:
      "Does your mind switch to Do Not Disturb mode the moment your vacation starts? Is your perfect getaway all about sandy beaches, a cocktail in hand, and zero worries? If travel for you is the ultimate way to recharge, we’ve got the perfect destinations lined up just for you.",
  };
  ...
  return (
    <div className="">
      ...
      <ParentComponent styles="my-20">
        <HeadLine
          title="Celebrate Easter Monday and Italy Around the Globe"
          description="Discover How to Turn These Spring Holidays into an International Adventure"
        />
